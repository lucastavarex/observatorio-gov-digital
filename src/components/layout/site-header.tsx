            ...
            {navItems.map(item => {
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className={cn(
                        'flex items-center gap-1 rounded-md px-2 py-2 text-[13px] font-medium transition-colors',
                        active
                          ? 'text-primary'
                          : isOpen
                            ? 'text-foreground'
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    'relative rounded-md px-2 py-2 text-[13px] font-medium transition-colors',
                    active
                      ? 'text-primary'
                      : 'text-muted-foreground hover:text-foreground'
                  )}
