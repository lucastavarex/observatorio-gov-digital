...
export const GLOSSARIO = {
  ...
  mediaDoNivel:
    'Para cada objetivo, é a média das notas dos entes daquele nível (por exemplo, todos os estados ou todas as capitais) que têm dado. Serve de referência de comparação — não é um ranking nem a média entre objetivos diferentes.',
  scoreTag:
